...
`SPEC-verdict-evidence.md`); `lane` is ADR-0081; `intent.generator` is ADR-0078. All are
optional on read — older records parse with empty defaults.
